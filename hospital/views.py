...
#for showing signup/login button for admin(by Divya Nagwanshi)
...
#for showing signup/login button for doctor(by Divya Nagwanshi)
...
#for showing signup/login button for patient(by Divya Nagwanshi)
...
#-----------for checking user is doctor , patient or admin(by Divya Nagwanshi)
def is_admin(user):
